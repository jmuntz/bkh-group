...
import { VERSION_CATALOG, type DesignNotesVariant } from '@/lib/design-notes';

type PreviewToolbarProps = {
  variant: DesignNotesVariant;
};

const VERSIONS = (Object.keys(VERSION_CATALOG) as DesignNotesVariant[]).map(
  (id) => VERSION_CATALOG[id]
);
